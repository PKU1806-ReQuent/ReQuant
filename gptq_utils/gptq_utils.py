...
class GPTQ:
    ...
    def fasterquant(
        ...
        # Groups columns of the weight matrix into groups of size groupsize
        # For example, if groupsize is 16, and the weight matrix has 1024 columns,
        # the weight matrix will be grouped into 64 groups of 16 columns each.
        if static_groups:
            groups = []
        ...
        # Sorts the weight matrix by the diagonal of the Hessian matrix in descending order.
        if actorder:
